...
public class DiningAreaController {
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Área de comedor encontrada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = DiningAreaDTO.class))),
        @ApiResponse(responseCode = "404", description = "Área de comedor no encontrada", content = @Content(mediaType = MediaType.TEXT_PLAIN)),
    ...
    public Response getDiningArea(
            @Parameter(description = "ID del área de comedor")
        ...
        try {
            ...
            return Response.status(CodigoRespuesta.ERROR_INTERNO.getValue())
                    .entity("Error obteniendo el área de comedor.").build();
        }
    }
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Áreas de comedor encontradas", content = @Content(mediaType = MediaType.APPLICATION_JSON)),
        @ApiResponse(responseCode = "404", description = "No hay áreas de comedor registradas", content = @Content(mediaType = MediaType.TEXT_PLAIN)),
        @ApiResponse(responseCode = "500", description = "Error interno", content = @Content(mediaType = MediaType.TEXT_PLAIN))
    })
    public Response getDiningAreas() {
        try {
            ...
            return Response.ok(new GenericEntity<List<DiningAreaDTO>>((List<DiningAreaDTO>) r.getResultado("DiningAreas")) {
            }).build();
        } catch (Exception ex) {
            Logger.getLogger(DiningAreaController.class.getName()).log(Level.SEVERE, null, ex);
            return Response.status(CodigoRespuesta.ERROR_INTERNO.getValue())
                    .entity("Error obteniendo las áreas de comedor").build();
        }
    }
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Áreas de comedor activas encontradas", content = @Content(mediaType = MediaType.APPLICATION_JSON)),
        @ApiResponse(responseCode = "404", description = "No hay áreas de comedor activas", content = @Content(mediaType = MediaType.TEXT_PLAIN)),
        @ApiResponse(responseCode = "500", description = "Error interno", content = @Content(mediaType = MediaType.TEXT_PLAIN))
    })
    public Response getActiveDiningAreas() {
        try {
            ...
            Logger.getLogger(DiningAreaController.class.getName()).log(Level.SEVERE, null, ex);
            return Response.status(CodigoRespuesta.ERROR_INTERNO.getValue())
                    .entity("Error obteniendo las áreas de comedor activas").build();
        }
    }
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Área de comedor guardada exitosamente", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = DiningAreaDTO.class))),
        @ApiResponse(responseCode = "404", description = "Área de comedor no encontrada", content = @Content(mediaType = MediaType.TEXT_PLAIN)),
        @ApiResponse(responseCode = "500", description = "Error interno", content = @Content(mediaType = MediaType.TEXT_PLAIN))
    })
    public Response guardarDiningArea(DiningAreaDTO diningArea) {
        try {
            ...
            Logger.getLogger(DiningAreaController.class.getName()).log(Level.SEVERE, null, ex);
            return Response.status(CodigoRespuesta.ERROR_INTERNO.getValue())
                    .entity("Error guardando el área de comedor.").build();
        }
    }
    ...
    public Response eliminarDiningArea(
        ...
        try {
            ...
            Logger.getLogger(DiningAreaController.class.getName()).log(Level.SEVERE, null, ex);
            return Response.status(CodigoRespuesta.ERROR_INTERNO.getValue())
                    .entity("Error eliminando el área de comedor.").build();
        }
    }
}
