...
public class SystemParameterService {
  ...
  public Respuesta getSystemParameter(Long id) {
    try {
      ...
      return new Respuesta(
          ...
          "",
          "SystemParameter",
          new SystemParameterDTO((SystemParameter) qryParam.getSingleResult()));
  ...
  public Respuesta getSystemParameterByName(String paramName) {
    try {
      Query qryParam =
          em.createNamedQuery("SystemParameter.findByParamName", SystemParameter.class);
  ...
  public Respuesta getSystemParameters() {
    try {
      ...
      return new Respuesta(
          true, CodigoRespuesta.CORRECTO, "", "", "SystemParameters", parametersDto);
    } catch (NoResultException ex) {
      return new Respuesta(
          false,
          CodigoRespuesta.ERROR_NOENCONTRADO,
