...
public class ProductGroupService {
    ...
    private static final Logger LOG = Logger.getLogger(
        ProductGroupService.class.getName()
    );
    ...
    public Respuesta getProductGroup(Long id) {
        try {
            Query qryProductGroup = em.createNamedQuery(
                "ProductGroup.findById",
                ProductGroup.class
            );
            ...
            return new Respuesta(
                ...
                "ProductGroup",
                new ProductGroupDTO(
                    (ProductGroup) qryProductGroup.getSingleResult()
                )
            );
    ...
    public Respuesta guardarProductGroup(ProductGroupDTO productGroupDto) {
        try {
            ...
            if (
                productGroupDto.getId() != null && productGroupDto.getId() > 0
            ) {
                productGroup = em.find(
                    ProductGroup.class,
