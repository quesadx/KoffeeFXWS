        ...
        try {
            ...
            if (invoiceDto.getId() != null && invoiceDto.getId() > 0) {
                ...
                if (invoiceDto.getCustomerOrderId() != null) {
                    CustomerOrder order =
                            em.find(CustomerOrder.class, invoiceDto.getCustomerOrderId());
                    if (order != null) {
                ...
                if (invoiceDto.getCashOpeningId() != null) {
                    CashOpening cashOpening =
                            em.find(CashOpening.class, invoiceDto.getCashOpeningId());
                    if (cashOpening != null) {
                ...
                if (invoiceDto.getCustomerOrderId() != null) {
                    try {
                        Query qryExisting =
                                em.createNamedQuery("Invoice.findByOrderId", Invoice.class);
