...
public class ReportService {
  ...
  private Respuesta prepararReporte(Long orderId) {
    try {
      ...
      parameters.put("taxAmount", invoice.getTaxAmount() != null ? invoice.getTaxAmount() : 0.0);
      parameters.put(
          "serviceAmount", invoice.getServiceAmount() != null ? invoice.getServiceAmount() : 0.0);
      parameters.put(
          "discountAmount",
      ...
      parameters.put(
          "changeAmount", invoice.getChangeAmount() != null ? invoice.getChangeAmount() : 0.0);
      ...
      parameters.put(
          "serviceRate", invoice.getServiceRate() != null ? invoice.getServiceRate() : 0.0);
      parameters.put(
          "discountRate", invoice.getDiscountRate() != null ? invoice.getDiscountRate() : 0.0);
      ...
      return new Respuesta(true, CodigoRespuesta.CORRECTO, "", "", "JasperPrint", jasperPrint);
    } catch (Exception ex) {
  ...
  private Respuesta prepararReporteCashierClosing(Long cashOpeningId) {
    try {
      ...
      @SuppressWarnings("unchecked")
      List<InvoiceDTO> allInvoices = (List<InvoiceDTO>) invoicesResponse.getResultado("Invoices");
      ...
      for (InvoiceDTO invoice : allInvoices) {
        LOG.log(
            ...
            "Invoice: "
                ...
                + " | Customer: "
                + (invoice.getCustomerName() != null ? invoice.getCustomerName() : "NULL")
                + " | Total: "
                + invoice.getTotal());
      }
      ...
      CashOpeningDTO cashOpening = (CashOpeningDTO) cashOpeningResponse.getResultado("CashOpening");
      ...
      InputStream reportStream = getClass().getResourceAsStream("/reports/Cashier-Report.jrxml");
      if (reportStream == null) {
        return new Respuesta(
            false,
            CodigoRespuesta.ERROR_INTERNO,
      ...
      LOG.log(
          Level.INFO, "Compilando reporte Cashier-Report.jrxml con lenguaje Java (JDT compiler)");
      JasperReport jasperReport = JasperCompileManager.compileReport(reportStream);
  ...
  public Respuesta generarReporteCashierPDFBytes(Long cashOpeningId) {
    try {
      ...
      LOG.log(Level.SEVERE, "Ocurrió un error al generar el reporte de cierre de caja PDF.", ex);
      return new Respuesta(
          false,
          CodigoRespuesta.ERROR_INTERNO,
  ...
  private Respuesta prepararReporteInvoicesByDate(LocalDate dateFrom, LocalDate dateTo) {
    try {
      ...
      JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(invoicesByDateRange);
      ...
      InputStream reportStream = getClass().getResourceAsStream("/reports/Invoices-Report.jrxml");
      if (reportStream == null) {
        return new Respuesta(
            false,
            CodigoRespuesta.ERROR_INTERNO,
      ...
      LOG.log(
          Level.INFO, "Compilando reporte Invoices-Report.jrxml con lenguaje Java (JDT compiler)");
      JasperReport jasperReport = JasperCompileManager.compileReport(reportStream);
      ...
      LOG.log(Level.SEVERE, "Ocurrió un error al preparar el reporte de facturas por fecha.", ex);
  ...
  public Respuesta generarReporteInvoicesByDatePDFBytes(LocalDate dateFrom, LocalDate dateTo) {
    try {
      ...
      LOG.log(Level.INFO, "Reporte de facturas por fecha PDF generado exitosamente como bytes");
      return new Respuesta(
          true,
          CodigoRespuesta.CORRECTO,
          "Reporte generado exitosamente.",
      ...
      LOG.log(
          Level.SEVERE, "Ocurrió un error al generar el reporte de facturas por fecha PDF.", ex);
      return new Respuesta(
          false,
          CodigoRespuesta.ERROR_INTERNO,
  ...
  private Respuesta prepararReporteProductosMasVendidos(LocalDate dateFrom, LocalDate dateTo) {
    try {
      ...
      for (InvoiceDTO invoice : invoicesByDateRange) {
        ...
        Respuesta orderResponse = orderService.getCustomerOrder(invoice.getCustomerOrderId());
          ...
          if (order != null && order.getOrderItems() != null) {
            ...
            for (OrderItemDTO item : order.getOrderItems()) {
              ...
              if (item.getProductId() != null) {
                try {
                  Respuesta productResponse = productService.getProduct(item.getProductId());
                  if (productResponse.getEstado()) {
                    ProductDTO product = (ProductDTO) productResponse.getResultado("Product");
                    if (product != null && product.getProductGroupName() != null) {
                  ...
                  LOG.log(
                      Level.WARNING,
                      "No se pudo obtener grupo de producto para item " + item.getProductId(),
                      ex);
                }
              }
      ...
      JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(productSalesList);

      // 10. Compilar el informe desde /reports/Products-Report.jrxml
      InputStream reportStream = getClass().getResourceAsStream("/reports/Products-Report.jrxml");
      if (reportStream == null) {
        return new Respuesta(
            false,
            CodigoRespuesta.ERROR_INTERNO,
      ...
      LOG.log(
          Level.INFO, "Compilando reporte Products-Report.jrxml con lenguaje Java (JDT compiler)");
      JasperReport jasperReport = JasperCompileManager.compileReport(reportStream);
      ...
      LOG.log(
          Level.SEVERE, "Ocurrió un error al preparar el reporte de productos más vendidos.", ex);
      return new Respuesta(
          false,
          CodigoRespuesta.ERROR_INTERNO,
  ...
  public Respuesta generarReporteProductosMasVendidosPDFBytes(
    ...
    try {
      ...
      LOG.log(Level.INFO, "Reporte de productos más vendidos PDF generado exitosamente como bytes");
      return new Respuesta(
          true,
          CodigoRespuesta.CORRECTO,
          "Reporte generado exitosamente.",
