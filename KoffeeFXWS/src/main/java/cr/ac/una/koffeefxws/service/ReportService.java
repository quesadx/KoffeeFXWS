    ...
    private Respuesta prepararReporte(Long orderId) {
        try {
            ...
            if (paramsResponse.getEstado()) {
                ...
                List<SystemParameterDTO> systemParams = (List<SystemParameterDTO>) paramsResponse.getResultado("SystemParameters");
            ...
            parameters.put("invoiceNumber", invoice.getInvoiceNumber() != null ? invoice.getInvoiceNumber() : "");
            parameters.put("invoiceDate", invoice.getCreatedAt()); // LocalDate directamente
            parameters.put("customerName", order.getCustomerName() != null ? order.getCustomerName() : "Cliente General");
            parameters.put("paymentMethod", invoice.getPaymentMethod() != null ? invoice.getPaymentMethod() : "CASH");
            ...
            parameters.put("serviceAmount", invoice.getServiceAmount() != null ? invoice.getServiceAmount() : 0.0);
            parameters.put("discountAmount", invoice.getDiscountAmount() != null ? invoice.getDiscountAmount() : 0.0);
            parameters.put("total", invoice.getTotal() != null ? invoice.getTotal() : 0.0);
            
            // Información de pago
            parameters.put("amountReceived", invoice.getAmountReceived() != null ? invoice.getAmountReceived() : 0.0);
            parameters.put("changeAmount", invoice.getChangeAmount() != null ? invoice.getChangeAmount() : 0.0);
            ...
            parameters.put("serviceRate", invoice.getServiceRate() != null ? invoice.getServiceRate() : 0.0);
            parameters.put("discountRate", invoice.getDiscountRate() != null ? invoice.getDiscountRate() : 0.0);
